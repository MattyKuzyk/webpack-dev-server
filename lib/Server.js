...
function Server(compiler, options) {
	...
	if(options.contentBase !== false) {
		...
		if(typeof contentBase === "object") {
			...
			app.get("*", this.setContentHeaders.bind(this), this.serveMagicHtml.bind(this), express.static(contentBase, {index: false, extensions: ["html", "htm"]}), serveIndex(contentBase));
		}
	}
